...
export default function FinalCtaDesktop() {
  return (
    <section id="final-cta" className="font-['Outfit',sans-serif]">
      <div className="bg-gradient-to-r from-[#6B21A8] via-[#7C3AED] to-[#D946EF] py-16">
      ...
      <footer className="bg-white border-t border-gray-100 py-6">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <p className="text-center text-[11px] font-bold uppercase tracking-[0.2em] text-[#6B21A8]/40 mt-5 mb-0">
