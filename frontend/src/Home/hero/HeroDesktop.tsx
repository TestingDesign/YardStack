            ...
            <div className="flex items-center gap-4 mt-6">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-white overflow-hidden bg-gradient-to-br from-[#6B21A8]/20 to-[#D946EF]/20 shadow-sm"
                  >
                    <img
          ...
          <div className="relative flex items-center justify-center h-[500px] lg:h-[600px] w-full">
            ...
            <div
              ...
              style={{
                transform: 'translate(-50%, -50%)',
                background:
                  'radial-gradient(circle, rgba(107, 33, 168, 0.08) 0%, rgba(107, 33, 168, 0.02) 50%, transparent 70%)',
              }}
            />
            ...
            <div
              className="absolute left-1/2 top-1/2 z-10 flex items-center justify-center w-[140px] h-[140px] rounded-full shadow-[0_10px_50px_rgba(107,33,168,0.35)] border-[6px] border-white"
              style={{
                transform: 'translate(-50%, -50%)',
