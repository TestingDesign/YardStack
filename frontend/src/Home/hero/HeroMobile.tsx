    ...
    >
      ...
      <div className="px-4 py-10 relative z-10">
        <div className="flex flex-col gap-4 ys-fade-in-up">
          ...
          <div className="flex items-center gap-3 mt-4">
            <div className="flex -space-x-2.5">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-8 h-8 rounded-full border-2 border-white overflow-hidden bg-gradient-to-br from-[#6B21A8]/20 to-[#D946EF]/20 shadow-sm">
        ...
        <div className="relative flex items-center justify-center h-[340px] mt-10 w-full">
          ...
          <div className="absolute left-1/2 top-1/2 z-10 flex items-center justify-center w-[90px] h-[90px] rounded-full shadow-[0_8px_30px_rgba(107,33,168,0.3)] border-4 border-white" style={{ transform: 'translate(-50%, -50%)', background: 'linear-gradient(135deg, #7C3AED 0%, #6B21A8 50%, #5B1D99 100%)' }}>
