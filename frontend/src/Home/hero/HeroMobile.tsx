      ...
      <div className="px-4 py-10 relative z-10">
        <div className="flex flex-col gap-4 ys-fade-in-up">
          ...
          <div className="flex flex-col gap-3 mt-2">
            <button className="w-full flex items-center justify-center px-6 py-3.5 rounded-lg bg-[#5B1D99] text-white text-[14px] font-bold border-none cursor-pointer shadow-[0_4px_14px_rgba(91,29,153,0.39)] transition-all active:scale-[0.98]">
              {HERO_CONTENT.primaryCta}
            </button>
            <button className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-white text-[#374151] text-[14px] font-bold border border-gray-200 cursor-pointer transition-all active:bg-gray-50">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="flex flex-col">
              <span className="text-[11px] font-bold text-[#1A1A2E]">{HERO_CONTENT.supportingTextBold}</span>
              <span className="text-[11px] font-medium text-[#6B7280]">{HERO_CONTENT.supportingText}</span>
            </div>
          </div>
        </div>

        <div className="relative flex items-center justify-center h-[340px] mt-10 w-full">
          <div className="absolute w-[240px] h-[240px] rounded-full border border-gray-200/60" />
          <div className="absolute w-[160px] h-[160px] rounded-full border border-gray-200/60" />

          <div className="relative z-10 flex items-center justify-center w-[90px] h-[90px] rounded-full bg-[#5B1D99] shadow-[0_8px_30px_rgba(91,29,153,0.3)] border-4 border-white">
          ...
          {ECOSYSTEM_CATEGORIES.slice(0, 5).map((cat, i) => {
            ...
            return (
              <div
                key={i}
                className="absolute z-20 flex flex-col items-center justify-center gap-1.5 rounded-xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] px-3 py-2.5 min-w-[100px] text-center ys-fade-in"
                style={{
              ...
              >
                <div className="w-7 h-7 rounded-full bg-[#F5F3FF] flex items-center justify-center">
