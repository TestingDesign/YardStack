  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full h-full mx-auto">
        ...
        <a
          href="#hero"
          className={`relative flex shrink-0 items-center outline-none focus-visible:ring-2 focus-visible:ring-purple-500/50 rounded-sm transition-all duration-700 ease-out active:scale-95 h-10 ${
            scrolled ? 'w-27.5' : 'w-40 translate-x-0'
          }`}
        >
          <img
            src={Logo}
        ...
        <div className="flex-1 min-w-20 lg:min-w-30" aria-hidden="true" />
          ...
          {NAV_CTAS.map((cta) => {
            ...
            return (
              <a
                ...
                className={`group inline-flex items-center justify-center px-6 py-2.5 rounded-sm text-[13px] font-extrabold transition-all duration-300 ease-out outline-none focus-visible:ring-2 focus-visible:ring-purple-500/50 cursor-pointer ${
                  isPrimary
