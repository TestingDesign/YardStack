...
import { parseDuration } from './PodcastVideoPlayerShared'
...
export default function InlineFeedPlayer({ episode }: { episode: PodcastEpisode }) {
  ...
  return (
    <div className="absolute inset-0 bg-black z-20 border border-white/20 box-border pointer-events-auto rounded-[inherit]">
      ...
      <button 
        className="absolute top-2 right-2 w-7 h-7 rounded-md bg-black/50 backdrop-blur-sm flex items-center justify-center text-white hover:bg-black/70 transition-colors z-20"
